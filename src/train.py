...
def get_args():
    ...
    parser.add_argument('--root', '-r', type=str, default='D:/AI-8/data', help='Path to dataset root directory')
...
def train(args):
    ...
    model.fc = nn.Linear(2048, 10)  # 5 nhóm tuổi * 2 giới tính = 10 lớp
    model.to(device)
    ...
    for epoch in range(start_epoch, args.num_epoch):
        ...
        plot_confusion_matrix(writer, cm, [f'{age}-{gender}' for age in ['18-20', '21-30', '31-40', '41-50', '51-60'] for gender in ['Female', 'Male']], epoch)
